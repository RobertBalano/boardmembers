...
type Page = 'dashboard' | 'meetings' | 'members' | 'minutes' | 'actions' | 'documents' | 'workflow' | 'voting' | 'analytics' | 'resolutions' ;
    ...
    <aside className="w-64 bg-primary-900 min-h-screen flex flex-col">
      <div className="px-6 py-6 border-b border-primary-800/50">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <p className="text-white font-semibold text-sm leading-tight">BoardMem</p>
            <p className="text-primary-300 text-xs">Board Member Portal</p>
          </div>
        </div>
      </div>
